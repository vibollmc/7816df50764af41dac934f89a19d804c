...
qq.FileUploaderBasic = function(o){
    ...
    this._options = {
        ...
        // messages
        messages: {
            typeError: "{file} sai định dạng file cho phép. Chỉ định dạng {extensions} {isAre} được chấp nhận.",
            sizeError: "{file} quá lớn, dung lượng tối đa cho phép là {sizeLimit}.",
            minSizeError: "{file} is too small, minimum file size is {minSizeLimit}.",
            emptyError: "{file} trống, vui lòng chọn file và thử lại.",
            noFilesError: "Không có file nào được tải lên.",
            onLeave: "File đang được tải lên. Nếu bạn tiếp tục chuyển sang trang khác trong lúc này quá trình tải lên sẽ bị hủy bỏ"
        },
