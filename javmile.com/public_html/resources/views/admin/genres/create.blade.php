...
<div class="block">
    ...
    <form action="{{ route('store_genres') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <label class="switch switch-primary" for="menu">
                                <input type="checkbox" <?php echo (old('menu')==null)? '':'checked'; ?> id="menu" name="menu" value="1">
                                <span data-toggle="tooltip" title="" data-original-title="ON/OFF"></span>
                            </label>
                        </div>
                    </div>
