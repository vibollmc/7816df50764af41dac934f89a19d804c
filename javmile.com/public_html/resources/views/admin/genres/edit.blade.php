...
<div class="block">
    ...
    <form action="{{ route('update_genres', $result->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <div class="col-md-6">
                <!-- Basic Form Elements Block -->
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="example-multiple-select">Menu</label>
                        <div class="col-md-9">
                            <label class="switch switch-primary" for="menu">
                                <input type="checkbox" <?php if(old('menu')==1){ echo 'checked';}else{if($result->menu==1){echo 'checked';}} ?> id="menu" name="menu" value="1">
                                <span data-toggle="tooltip" title="" data-original-title="ON/OFF"></span>
                            </label>
                        </div>
                    </div>
