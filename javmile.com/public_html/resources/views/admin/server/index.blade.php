        ...
        <table id="general-table" class="table table-striped table-vcenter">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->type }}</td>
                        <td><a href="javascript:void(0)" class="label <?php echo $item->default == 1? 'label-success">ON': 'label-warning">OFF'; ?></a></td>
                        <td><a href="javascript:void(0)" class="label <?php echo $item->status == 1? 'label-success">ON': 'label-warning">OFF'; ?></a></td>
                        <td class="text-center">
                            <div class="btn-group btn-group-xs">
                                <a href="{{ route('edit_server',$item->id) }}" data-toggle="tooltip" title="Edit" class="btn btn-default"><i class="fa fa-pencil 2x"></i></a>
                                <a onclick="return confirm('Click OK to confirm delete.');" href="{{ route('delete_server', $item->id) }}" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-times"></i></a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
