...
<div class="block">
    ...
    <form action="{{ route('update_country', $result->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <div class="col-md-6">
                <!-- Basic Form Elements Block -->
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="example-email-input">Code</label>
                        <div class="col-md-9">
                            <input type="text" name="code" value="<?php echo old('code')? old('code'): $result->code; ?>" class="form-control" placeholder="">
