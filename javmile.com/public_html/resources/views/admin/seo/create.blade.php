...
<div class="block">
    ...
    <form action="{{ route('store_orther_seo') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            @foreach($slug as $key => $item)
                                <option value="{{$key}}" <?php echo old('slug')==$key? 'selected':''; ?>>{{$item}}</option>
                            @endforeach
                            </select>
