        ...
        <div class="col-sm-6 col-xs-5">
            <div class="dataTables_length" id="example-datatable_length">
                <div class="btn-group btn-group-sm pull-left">
                    <a href="{{ route('create_orther_seo') }}" class="btn btn-primary">New</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <table id="general-table" class="table table-striped table-vcenter">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('edit_orther_seo',$item->id) }}">{{ $item->title }}</a></td>
                        <td>{{ $item->slug }}</td>
                        <td class="text-center">
                            <div class="btn-group btn-group-xs">
                                <a href="{{ route('edit_orther_seo',$item->id) }}" data-toggle="tooltip" title="Edit" class="btn btn-default"><i class="fa fa-pencil 2x"></i></a>
                                <a onclick="return confirm('Click OK to confirm delete.');" href="{{ route('delete_orther_seo', $item->id) }}" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-times"></i></a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
