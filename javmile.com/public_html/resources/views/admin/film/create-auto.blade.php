        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                ...
                <form action="{{ route('get_info_auto') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    {!!csrf_field()!!}
                    <div class="">
                        <input name="url" class="form-control" type="url" value="{{$url}}">
                    </div>
        ...
        <div>
                ...
                <div class="col-md-6">
                    <!-- Basic Form Elements Block -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="title" class="form-control to-slug" placeholder="" value="{{ $respons['title'] or '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="title_en" class="form-control to-slug" placeholder="" value="{{$respons['title_en'] or ''}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="number" name="date" value="{{$respons['date'] or ''}}" class="form-control" placeholder="{{date('Y', time())}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="stars" value="{{implode(',', $respons['actor'])}}" class="form-control" placeholder="add a star">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="director" value="{{ implode(',', $respons['director']) }}" class="form-control" placeholder="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="category_id" class="select-chosen" id="category_id" data-placeholder="Choose a category..">
                                    ...
                                    <option value="{{ $category->id}}" {{(isset($respons['episodes']) and $category->id == 2)? 'selected': ''}} {{(!isset($respons['episode']) and $category->id == 1)? 'selected': ''}}>{!! $category->title !!}</option>
                                    @endforeach
                                </select>
                ...
                <div class="col-md-6">
                    <!-- Basic Form Elements Block -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="country[]" class="select-chosen" data-placeholder="Choose a country.." multiple>
                                    ...
                                    <option value="{{ $country->id}}" {{in_array($country->title, $respons['country'])? 'selected': ''}}>{!! $country->title !!}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="genre[]" class="select-chosen" data-placeholder="Choose a genre.." multiple>
                                    ...
                                    <option value="{{ $genre->id}}" {{in_array($genre->title, $respons['genre'])? 'selected': ''}}>{!! $genre->title !!}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="episodes" class="form-control number"  value="{{$respons['episodes'] or '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input type="text" name="runtime" class="form-control number"  value="{{ $respons['runtime'] or '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="imdb_url" class="form-control" placeholder="Url" value="{{ $respons['imdb_url'] or '' }}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea style="height: 100px;" class="form-control" name="description">{{ str_limit($respons['content'], 160) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            ...
                            <input type="hidden" name="auto_thumb" value="{{$respons['thumb']}}">
                            <img src="{{old('auto_thumb')? old('auto_thumb'): $respons['thumb']}}" style="max-width: 150px;" class="img-responsive" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="form-bordered">
                <div class="form-group">
                    ...
                    <textarea id="ckeditor" name="storyline" class="form-control">{{ $respons['content'] }}</textarea>
...
<script type="text/javascript">
    $('#postFilm').submit(function(){
        if ($('[name="thumb"]').val().length == 0 && $('[name="auto_thumb"]').val().length == 0) {
