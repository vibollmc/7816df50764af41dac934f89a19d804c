...
<div class="block">
    ...
    <form action="{{ route('update_user',$result->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <select id="example-select" name="group_id" class="form-control" size="1">
                                ...
                                <option value="{{ $type->id }}" <?php echo ($result->group_id == $type->id or old('group_id')== $type->id)? 'selected':''; ?>>{!! $type->title !!}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
